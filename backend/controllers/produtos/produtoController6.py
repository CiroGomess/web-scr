...
async def verificar_bloqueios_unico(page):
    ...
    if not bloqueios_removidos:
        ...
        try:
            # Espera 3 segundos para o popup aparecer (solicitado)
            ...
            if await btn_fechar.count() > 0 and await btn_fechar.is_visible():
                ...
                await asyncio.sleep(1) # Espera sumir
                print("✅ Pop-up fechado.")
            else:
                print("👍 Nenhum pop-up apareceu.")
                
            # Marca como feito para não tentar nos próximos produtos
...
async def buscar_produto(page, codigo):
    """Digita o código no campo #search-prod e trata pop-ups"""
    try:
        ...
        try:
            await page.wait_for_selector("table tbody tr.odd", timeout=8000)
        except:
            pass 
...
async def extrair_dados_produto(page, codigo_solicitado, quantidade_solicitada=1):
    ...
    linha_selector = "table tbody tr.odd"
    ...
    if await page.locator(linha_selector).count() == 0:
        ...
        return {
            ...
            "uf": "SC", "qtdSolicitada": quantidade_solicitada, "qtdDisponivel": 0,
...
def preparar_dados_finais(lista_itens):
    ...
    return {
        ...
        "data_obj": agora,
        "fornecedror": "Fornecedor 6 (Laguna)",
